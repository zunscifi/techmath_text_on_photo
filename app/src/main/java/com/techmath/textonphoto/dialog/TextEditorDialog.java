...
import com.techmath.textonphoto.activities.TextArtActivity;
import com.techmath.textonphoto.fragments.ThoughtsFragment;
...
public class TextEditorDialog extends Dialog implements View.OnClickListener, ThoughtsFragment.ThoughtsFragmentListener {
    ...
    public TextEditorDialog(@NonNull final TextArtActivity editPhotoActivity, String str) {
